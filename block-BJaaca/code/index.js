...
character.great = alert(`I am Narasimhulu Vasam and my title is MERN Stack Developer`);
...
character["great"] = alert(`She is ramya and her title is tollywood actresses`)
...
character.changeIsAdult = isAdult
