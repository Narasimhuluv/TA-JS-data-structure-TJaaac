...
for(let pro of got.houses[0].people){
  console.log(pro.name)
}

// 5. Log the name of all the people in house Lannisters (index 1) one by one

for(let pro of got.houses[1].people){
  console.log(pro.name)
}

// 6. Log the description of all the people in house Lannisters (index 1) one by
...
for(let pro of got.houses[0].people){
  console.log(pro.name, pro.description)
}
...
for(let house of got.houses){
  for(let pro of house.people){
    allDescription.push(pro.description)
  }
}
// 19. Log the value and length `allDescription`
console.log(allDescription, allDescriptionl.length)
